...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Please contact @JackHubxOwner for the access of the bot."
...
✅ Usage: /remove <userid>'''
        ...
        response = "To get access of the bot please contact @JackHubxOwner🙇."
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @JackHubxOwner"
    bot.reply_to(message, response)
...
def run_attack_and_notify(message, user_id, target, port, time):
    ...
    if success:
        ...
        bot.reply_to(message, " ✨ I am free now to kill the server🙂 For Using type /bgmi")
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                attack_start_message = (
                    ...
                    f"𝐏𝐨𝐫𝐭: {port}\n"
                    f"𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n"
                    f"𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of :- @JackHubxOwner."
                )
